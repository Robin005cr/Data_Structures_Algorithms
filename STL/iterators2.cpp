...
int main()
{
    ...
    // Dynamically allocate objects and add to list
    objList.push_back(new ObjectInfo(1.0, 2.0, 3.0));
    objList.push_back(new ObjectInfo(4.0, 5.0, 6.0));
    objList.push_back(new ObjectInfo(7.0, 8.0, 9.0));
